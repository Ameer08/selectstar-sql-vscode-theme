...
### SelectStar – SSMS Light
![Editor](assets/ssms-light-editor.png)
![Create](assets/ssms-light-editor-create.png)
![View](assets/ssms-light-editor-view.png)

### SelectStar – Dark
![Editor](assets/dark-editor.png)
![Create](assets/dark-editor-create.png)
![View](assets/dark-editor-view.png)

### SelectStar – Dark (Pink Star)
![Editor](assets/dark-pinkstar-editor.png)
![Create](assets/dark-pinkstar-editor-create.png)
![View](assets/dark-pinkstar-editor-view.png)
